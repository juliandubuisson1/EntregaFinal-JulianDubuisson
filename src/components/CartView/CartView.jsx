...
const CartView = () => {
    ...
    if (cart.lenght === 0) return <EmtpyCart />
    ...
    return (
        <section className="container m-auto mt-8">
            ...
            <Boton onClick={clearCart} className="bg-teal-600 w-auto rounded-md"> Vaciar carrito </Boton>
            <Boton className="bg-teal-600 w-auto h-9 rounded-md flex justify-center place-content-center"> <Link to="/checkout" > Terminar mi compra </Link>
            </Boton>
        </section>
    );
};
